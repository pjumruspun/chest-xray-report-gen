...
MODEL_DIR = os.path.join(os.path.dirname(
    __file__), 'weights/brucechou1983_CheXNet_Keras_0.3.0_weights.h5')
...
class ChexNet(keras.Model):
    def __init__(self, input_shape=(224, 224, 3), pooling=None):
        ...
        output = Dense(OUTPUT_LAYER_SIZE, activation="sigmoid",
                       name="predictions")(densenet.output)
        ...
        self.feature_model = Model(
            inputs=chex_model.input, outputs=chex_model.layers[-2].output)
